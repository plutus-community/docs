// Static comments
// modified from: https://github.com/avglinux/alu-test-website/blob/master/assets/js/staticman.js
...
//(function ($) {
  ...
  $('.js-form').submit(function () {
    ...
    $('#comment-form-submit').html('Sending...');
    ...
    $.ajax({
      ...
      success: function (data) {
        showModal('Comment submitted', 'Thanks! Your comment will appear once it is approved.');
        $("#comment-form-submit")
          .html("Submit");
        $(form)[0].reset();
...
var addComment = {
  ...
  moveForm: function( commId, respondId, postId, parentUid ) {
    ...
    cancel.onclick = function() {
      ...
      t.I( 'comment-replying-to-uid' ).value = '0';
